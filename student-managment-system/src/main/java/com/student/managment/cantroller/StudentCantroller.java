package com.student.managment.cantroller;
...
import com.student.managment.Service.impl.StudentServiceImpl;

@Controller
public class StudentCantroller {
	private StudentService studentService;

	public StudentCantroller(StudentService studentService) {
		super();
